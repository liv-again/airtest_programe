...
data_old=block.offspring(resourceId="com.hexin.plat.android.ZhongyuanSecurity:id/item_content").attr("name")
time.sleep(5)
data_new=block.offspring(resourceId="com.hexin.plat.android.ZhongyuanSecurity:id/item_content").attr("name")
assert data_new != date_old ,"行情未刷新"
...
poco(resourceId="com.hexin.plat.android.ZhongyuanSecurity:id/gz_index_container").offspring(text="上证指数").click()
time.sleep(1)
...
swipe(Template(r"tpl1772905480846.png", record_pos=(0.001, 0.844), resolution=(1080, 2376)), vector=[-0.0293, -0.5945])  #这个滑动感觉得优化
...
touch(Template(r"tpl1773071985129.png", record_pos=(-0.206, 0.048), resolution=(1080, 2376)))
touch(Template(r"tpl1773071985821.png", record_pos=(-0.206, 0.048), resolution=(1080, 2376)))
touch(Template(r"tpl1773071987496.png", record_pos=(-0.012, 0.058), resolution=(1080, 2376)))
touch(Template(r"tpl1773071988630.png", record_pos=(-0.012, 0.058), resolution=(1080, 2376)))
touch(Template(r"tpl1773072159922.png", record_pos=(0.168, -0.512), resolution=(1080, 2376)))
...
touch(Template(r"tpl1772901356115.png", record_pos=(-0.408, -0.928), resolution=(1080, 2376))) 
swipe(Template(r"tpl1772971150235.png", record_pos=(0.189, -0.128), resolution=(1080, 2376)), vector=[-0.5599, 0.0111])
touch(Template(r"tpl1772905627159.png", record_pos=(-0.175, -0.357), resolution=(1080, 2376)))
touch(Template(r"tpl1772905642288.png", record_pos=(-0.369, -0.357), resolution=(1080, 2376)))
...
swipe(Template(r"tpl1772976466171.png", record_pos=(0.3, 0.027), resolution=(1080, 2376)), vector=[0.0169, 0.2102])
touch(Template(r"tpl1772977063980.png", record_pos=(0.331, 0.541), resolution=(1080, 2376)))
swipe(Template(r"tpl1772976484607.png", record_pos=(-0.064, 0.385), resolution=(1080, 2376)), vector=[-0.0356, -0.2707])
